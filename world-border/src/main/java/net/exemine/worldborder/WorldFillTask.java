...
import net.exemine.worldborder.events.WorldFillerTaskCompleteEvent;
import net.exemine.worldborder.events.WorldFillerTaskProgressEvent;
...
public class WorldFillTask implements Runnable
{
    ...
    WorldFillTask(Server theServer, Player player, String worldName, int fillDistance, int chunksPerRun, int tickFrequency, boolean forceLoad)
    {
    ...
    private void finish()
    {
        ...
        Bukkit.getServer().getPluginManager().callEvent(new WorldFillerTaskCompleteEvent(this.world, this.border));
    }
    ...
    private void reportProgress()
    {
        ...
        WorldFillerTaskProgressEvent event = new WorldFillerTaskProgressEvent(world.getName(), perc);
    ...
    void continueProgress(int x, int z, int length, int totalDone)
    {
        this.x = x;
        this.z = z;
        this.length = length;
