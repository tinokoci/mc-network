...
import net.exemine.api.util.config.configuration.MemoryConfiguration;
import net.exemine.api.util.config.configuration.MemoryConfigurationOptions;
...
public class FileConfigurationOptions extends MemoryConfigurationOptions {
    ...
    public FileConfigurationOptions header(@Nullable final String header) {
        this.header = (header == null) ? Collections.emptyList() : List.of(header.split("\\n"));
        return this;
    }
